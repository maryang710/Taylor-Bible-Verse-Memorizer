...
import edu.taylor.cse.sbrandle.biblemem.v001.dialog.FirstLetterHelpDialog;
...
public class FirstLetterAct extends Activity implements OnClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		TextView verseRefView = (TextView) findViewById(R.id.first_letter_verse_ref);
	...
	private void startFirstLetter(){
		...
		int num_of_hidden_words = GlobalMethod.getHiddenWordsNumber(hiddenWords);
