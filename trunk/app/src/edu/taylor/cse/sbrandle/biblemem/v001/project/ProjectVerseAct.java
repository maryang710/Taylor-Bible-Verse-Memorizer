...
import edu.taylor.cse.sbrandle.biblemem.v001.VerseChooserAct;
...
public class ProjectVerseAct extends Activity  implements OnClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		GlobalManager.setCustomContentView(this, R.layout.project_verse_list);
		...
		titleBarText.setText(databaseManager.getProject(projectId).getProjectName());
